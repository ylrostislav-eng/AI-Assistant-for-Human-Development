...
**Состояние на 15 сентября 2026: подготовлена архитектура v0.1. Приложение ещё не реализовано.**
...
5. [Аудит среды и команды проверки](docs/toolchain.md) — завершён P0-01a; сборки backend/iOS относятся к следующему шагу.
