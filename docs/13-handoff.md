...
| Time | Pure CalendarMath, точное смещение пояса, разрыв и наложение по каждой минуте (**T-00c выполнен**), ensureUserDay | T-00d: пересекающиеся дни при смене границы; Scheduler/day-close/reminders |
