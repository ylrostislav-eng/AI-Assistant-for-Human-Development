...
**Нет:** живого поставщика, сохранения разговоров и ходов, памяти, ролей,
проверок расхода, GoalPlanDraft, reviews. Раздел 2 называет OpenAI Responses API
как выбранное направление; фактическая реализация от формы ответа конкретного
поставщика не зависит.
